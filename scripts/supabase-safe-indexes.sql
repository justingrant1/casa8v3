-- =====================================================================
-- CASA8 DATABASE INDEX OPTIMIZATION - SAFE VERSION
-- =====================================================================
-- Only indexes for columns that definitely exist in your database
...
CREATE INDEX IF NOT EXISTS idx_properties_active_bathrooms 
...
CREATE INDEX IF NOT EXISTS idx_properties_active_created_desc 
...
CREATE INDEX IF NOT EXISTS idx_properties_city_bedrooms 
ON properties(is_active, city, bedrooms) 
WHERE is_active = true;

-- State + Price range (market analysis queries)
CREATE INDEX IF NOT EXISTS idx_properties_state_price 
ON properties(is_active, state, price) 
WHERE is_active = true;

-- Bedrooms + Bathrooms + Price (detailed property searches)
CREATE INDEX IF NOT EXISTS idx_properties_bed_bath_price 
...
CREATE INDEX IF NOT EXISTS idx_properties_title_text 
ON properties USING gin(to_tsvector('english', title)) 
WHERE is_active = true;

-- Description search optimization  
CREATE INDEX IF NOT EXISTS idx_properties_description_text 
ON properties USING gin(to_tsvector('english', description)) 
WHERE is_active = true;

-- Address search optimization
CREATE INDEX IF NOT EXISTS idx_properties_address_text 
...
-- =====================================================================
-- 6. MESSAGES TABLE OPTIMIZATION (SAFE COLUMNS ONLY)
-- =====================================================================
...
-- Property-related messages (only if property_id exists)
...
CREATE INDEX IF NOT EXISTS idx_profiles_section8 
